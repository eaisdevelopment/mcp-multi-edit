...
- Added missing changelog entries for v0.2.4 and v0.2.6
- Fixed package.json files array referencing wrong file
...
### Changed
- Documentation: updated all config examples to use branded key name for proper display in Claude Code
- Documentation: added notes explaining Project vs Local MCPs and display name behavior
- Rewrote README with value proposition, benchmark stats, and links to detailed docs

### Added
- Comprehensive user documentation: installation guide, usage guide, troubleshooting guide (`docs/`)
...
[0.2.7]: https://github.com/eaisdevelopment/mcp-multi-edit/releases/tag/v0.2.7
